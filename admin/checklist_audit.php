            ...
            <form class="" action="proses/audit.php?page=3" method="post">
              <table style="margin-top:10px;width:100%">
                ...
                <tr>
                  ...
                  <td><input required type="radio" name="audit1" value="0"> </td>
                  <td><input required type="radio" name="audit1" value="1"></td>
                </tr>
                <tr>
                  <td>2. </td>
                  <td>Checklist pekerjaan sudah di lakukan oleh pengawas</td>
                  <td><input required type="radio" name="audit2" value="0"> </td>
                  <td><input required type="radio" name="audit2" value="1"></td>
                </tr>
                <tr>
                  <td>3. </td>
                  <td>Pengawas pekerjaan ada di tempat kerja</td>
                  <td><input required type="radio" name="audit3" value="0"> </td>
                  <td><input required type="radio" name="audit3" value="1"></td>
                </tr>
                <tr>
                  <td>4. </td>
                  <td>Pelaksana pekerja sesuai dengan surat penunjukan</td>
                  <td><input required type="radio" name="audit4" value="0"> </td>
                  <td><input required type="radio" name="audit4" value="1"></td>
                </tr>
                <tr>
                  <td>5. </td>
                  <td>APD yang digunakan pekerja sesuai pekerjaan</td>
                  <td><input required type="radio" name="audit5" value="0"> </td>
                  <td><input required type="radio" name="audit5" value="1"></td>
                </tr>
                <tr>
                  <td></td>
                  <td colspan="3">
                ...
                <tr>
                  ...
                  <td><input required type="radio" name="audit6" value="0"> </td>
                  <td><input required type="radio" name="audit6" value="1"></td>
                </tr>
                <tr>
                  <td>7. </td>
                  <td>Kondisi pekerja dalam keadaan sehat</td>
                  <td><input required type="radio" name="audit7" value="0"> </td>
                  <td><input required type="radio" name="audit7" value="1"></td>
                </tr>
                <tr>
                  <td>8. </td>
                  <td>Pekerjaan yang dilakukan sudah ada permit yang sesuai</td>
                  <td><input required type="radio" name="audit8" value="0"> </td>
                  <td><input required type="radio" name="audit8" value="1"></td>
                </tr>
                <tr>
                  <td>9. </td>
                  <td>Permit masih berlaku / belum expired</td>
                  <td><input required type="radio" name="audit9" value="0"> </td>
                  <td><input required type="radio" name="audit9" value="1"></td>
                </tr>
                <tr>
                  <td>10. </td>
                  <td>Safety sign masih terpasang sesuai dan dalam keadaan baik</td>
                  <td><input required type="radio" name="audit10" value="0"> </td>
                  <td><input required type="radio" name="audit10" value="1"></td>
                </tr>
                <tr>
                  <td>11. </td>
                  <td>Penerangan di lokasi kerja memadai</td>
                  <td><input required type="radio" name="audit11" value="0"> </td>
                  <td><input required type="radio" name="audit11" value="1"></td>
                </tr>
                <tr>
                  <td>12. </td>
                  <td>Lingkungan kerja aman, bebas dari bahaya pekerjaan lainya</td>
                  <td><input required type="radio" name="audit12" value="0"> </td>
                  <td><input required type="radio" name="audit12" value="1"></td>
                </tr>
                <tr>
                  <td>13. </td>
                  <td>Sirkulasi udara di sekitar pekerjaan memadai</td>
                  <td><input required type="radio" name="audit13" value="0"> </td>
                  <td><input required type="radio" name="audit13" value="1"></td>
                </tr>
                <tr>
                  <td>14. </td>
                  <td>Fire Watch ada di area kerja dan sesuai dengan surat penunjukan</td>
                  <td><input required type="radio" name="audit14" value="0"> </td>
                  <td><input required type="radio" name="audit14" value="1"></td>
                </tr>
                <tr>
                  <td>15. </td>
                  <td>Fire watch log terisi dan termonitor</td>
                  <td><input required type="radio" name="audit15" value="0"> </td>
                  <td><input required type="radio" name="audit15" value="1"></td>
                </tr>
                <tr>
                  <td>16. </td>
                  <td>Jumlah / penempatan Fire Watch sesuai dengan lokasi pekerjaan</td>
                  <td><input required type="radio" name="audit16" value="0"> </td>
                  <td><input required type="radio" name="audit16" value="1"></td>
                </tr>
                <tr>
                  <td></td>
                  <td colspan="4">
                ...
                <tr>
                  ...
                  <td><input required type="radio" name="audit17" value="0"> </td>
                  <td><input required type="radio" name="audit17" value="1"></td>
                </tr>
                <tr>
                  <td>18. </td>
                  <td>Emergency tools tersedia dan dalam keadaan baik</td>
                  <td><input required type="radio" name="audit18" value="0"> </td>
                  <td><input required type="radio" name="audit18" value="1"></td>
                </tr>
                  </table>
          </div>
        </div>
