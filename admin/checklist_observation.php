              ...
              <form class="" action="proses/observation.php?page=3" method="post">
                <table style="margin-top:10px;width:100%">
                  ...
                  <tr>
                    ...
                    <td><input required type="radio" name="tta1" value="1"> </td>
                    <td><input required type="radio" name="tta1" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">2. </td>
                    <td>Tersedia checklist pekerjaan yang dikerjakan</td>
                    <td><input required type="radio" name="tta2" value="1"> </td>
                    <td><input required type="radio" name="tta2" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">3. </td>
                    <td>Surat penunjukan pengawas sudah ada dan terisi</td>
                    <td><input required type="radio" name="tta3" value="1"> </td>
                    <td><input required type="radio" name="tta3" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">4. </td>
                    <td>Surat penunjukan pelaksana pekerjaan sudah ada dan terisi</td>
                    <td><input required type="radio" name="tta4" value="1"> </td>
                    <td><input required type="radio" name="tta4" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">5. </td>
                    <td>Checklist daftar dan kondisi APD sudah terisi dan sesuai</td>
                    <td><input required type="radio" name="tta5" value="1"> </td>
                    <td><input required type="radio" name="tta5" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">6. </td>
                    <td>Checklist kondisi peralatan pekerjaan sudah terisi dan sesuai</td>
                    <td><input required type="radio" name="tta6" value="1"> </td>
                    <td><input required type="radio" name="tta6" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">7. </td>
                    <td>Checklist daftar kesiapan / kondisi pelaksana pekerjaan sudah terisi</td>
                    <td><input required type="radio" name="tta7" value="1"> </td>
                    <td><input required type="radio" name="tta7" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">8. </td>
                    <td>Checklist pemeriksa penggunaan APD sudah terisi</td>
                    <td><input required type="radio" name="tta8" value="1"> </td>
                    <td><input required type="radio" name="tta8" value="0"></td>
                  </tr>
                  <tr>
                    <td></td>
                    <td colspan="3">
                  ...
                  <tr>
                    ...
                    <td><input required type="radio" name="tta9" value="1"> </td>
                    <td><input required type="radio" name="tta9" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">10. </td>
                    <td>Diperlukan standby first aider / standby person tambahan</td>
                    <td><input required type="radio" name="tta10" value="1"> </td>
                    <td><input required type="radio" name="tta10" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">11. </td>
                    <td>Diperlukan rambu peringatan bahaya disekitar pekerjaan</td>
                    <td><input required type="radio" name="tta11" value="1"> </td>
                    <td><input required type="radio" name="tta11" value="0"></td>
                  </tr>
                  <tr>
                    <td></td>
                    <td colspan="3">
                  ...
                  <tr>
                    ...
                    <td><input required type="radio" name="tta12" value="1"> </td>
                    <td><input required type="radio" name="tta12" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">13. </td>
                    <td>Dibutuhkan penerangan tambahan di area kerja jika kurang memadai</td>
                    <td><input required type="radio" name="tta13" value="1"> </td>
                    <td><input required type="radio" name="tta13" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">14. </td>
                    <td>Lingkungan kerja aman, bebas dari bahaya pekerjaan lainya </td>
                    <td><input required type="radio" name="tta14" value="1"> </td>
                    <td><input required type="radio" name="tta14" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">15. </td>
                    <td>Sirkulasi udara di sekitar pekerjaan memadai </td>
                    <td><input required type="radio" name="tta15" value="1"> </td>
                    <td><input required type="radio" name="tta15" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">16. </td>
                    <td>System peralatan unit diamankan dari pekerjaan yang berlangsung </td>
                    <td><input required type="radio" name="tta16" value="1"> </td>
                    <td><input required type="radio" name="tta16" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">17. </td>
                    <td>Tersedia surat penunjukan Fire Watch yang sudah terisi </td>
                    <td><input required type="radio" name="tta17" value="1"> </td>
                    <td><input required type="radio" name="tta17" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">18. </td>
                    <td>Jumlah Fire Watch sudah sesuai dengan pekerjaan pada lantai bertingkat </td>
                    <td><input required type="radio" name="tta18" value="1"> </td>
                    <td><input required type="radio" name="tta18" value="0"></td>
                  </tr>
                  <tr>
                    <td></td>
                    <td colspan="4">
                  ...
                  <tr>
                    ...
                    <td><input required type="radio" name="tta19" value="1"> </td>
                    <td><input required type="radio" name="tta19" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">20. </td>
                    <td>Tersedia impairment permit sesuai dengan FPE di sekitar </td>
                    <td><input required type="radio" name="tta20" value="1"> </td>
                    <td><input required type="radio" name="tta20" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">21. </td>
                    <td>Terdapat surat dari management untuk pekerjaan diatas jam normal </td>
                    <td><input required type="radio" name="tta21" value="1"> </td>
                    <td><input required type="radio" name="tta21" value="0"></td>
                  </tr>
                  <tr>
                    <td style="vertical-align:top">22. </td>
                    <td>Sudah dilakukan On Spot Induction </td>
                    <td><input required type="radio" name="tta22" value="1"> </td>
                    <td><input required type="radio" name="tta22" value="1"></td>
                  </tr>
                    </table>
            </div>
